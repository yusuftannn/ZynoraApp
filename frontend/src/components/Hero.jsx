  ...
  return (
    <section className='relative bg-hero bg-cover bg-center bg-no-repeat h-screen w-full'>
      <div className='max_padd_container relative top-32 xs:top-52'>
        ...
        Laborum omnis et harum dignissimos illo a suscipit vero quo adipisci laudantium 
        mollitia esse quidem doloribus, voluptatum doloremque, eos iusto quisquam dolores 
        cum recusandae reprehenderit!</p>
